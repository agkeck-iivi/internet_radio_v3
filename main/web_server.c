...
static esp_err_t config_page_handler(httpd_req_t *req) {
  const char *html_response =
      ...
      "  <div class='field'><label>Light Sleep Delay (seconds)</label><input type='number' id='lightDly'></div>"
      "  <div class='field'><label>Deep Sleep Delay (seconds)</label><input type='number' id='deepDly'></div>"
